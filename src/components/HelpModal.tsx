            ...
            icon={(
              <span className="help-glyph">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <rect x="2.5" y="2.5" width="19" height="19" rx="2.5" stroke="var(--border-color)" strokeWidth="1.5" strokeDasharray="3 2.5" />
                  <line x1="12" y1="8" x2="12" y2="16" stroke="var(--accent-color)" strokeWidth="2" strokeLinecap="round" />
                  <line x1="8" y1="12" x2="16" y2="12" stroke="var(--accent-color)" strokeWidth="2" strokeLinecap="round" />
                </svg>
              </span>
            )}
            title="Agregar fotograma"
          >
